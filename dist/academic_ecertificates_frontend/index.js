...
/* harmony export */   DER_COSE_OID: () => (/* reexport safe */ _dfinity_agent__WEBPACK_IMPORTED_MODULE_4__.DER_COSE_OID),
...
/* harmony export */   ED25519_OID: () => (/* reexport safe */ _dfinity_agent__WEBPACK_IMPORTED_MODULE_4__.ED25519_OID),
...
/* harmony export */   unwrapDER: () => (/* reexport safe */ _dfinity_agent__WEBPACK_IMPORTED_MODULE_4__.unwrapDER),
/* harmony export */   wrapDER: () => (/* reexport safe */ _dfinity_agent__WEBPACK_IMPORTED_MODULE_4__.wrapDER)
/* harmony export */ });
...
/***/ "./src/declarations/academic_ecertificates_backend/academic_ecertificates_backend.did.js":
/*!***********************************************************************************************!*\
  !*** ./src/declarations/academic_ecertificates_backend/academic_ecertificates_backend.did.js ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    'addCertificate' : IDL.Func(
        ...
        [IDL.Record({ 'msg' : IDL.Text, 'statusCode' : IDL.Nat })],
        [],
      ),
    'getCertificate' : IDL.Func(
        ...
        [
          IDL.Record({
            'msg' : IDL.Text,
            'cert' : IDL.Opt(Grad_cert),
            'university' : IDL.Opt(University),
            'statusCode' : IDL.Nat,
          }),
        ],
        ['query'],
      ),
    'getUniversity' : IDL.Func(
        [IDL.Opt(IDL.Principal)],
        [
          IDL.Record({
            'msg' : IDL.Text,
            'certs' : IDL.Opt(IDL.Vec(Grad_cert)),
            'university' : IDL.Opt(University),
            'statusCode' : IDL.Nat,
          }),
        ],
    ...
    'isAccountExists' : IDL.Func(
        [],
        [IDL.Record({ 'msg' : IDL.Text, 'statusCode' : IDL.Nat })],
        ['query'],
      ),
    'registerUniversity' : IDL.Func(
...
/***/ "./src/declarations/academic_ecertificates_backend/index.js":
/*!******************************************************************!*\
  !*** ./src/declarations/academic_ecertificates_backend/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   academic_ecertificates_backend: () => (/* binding */ academic_ecertificates_backend),
/* harmony export */   canisterId: () => (/* binding */ canisterId),
/* harmony export */   createActor: () => (/* binding */ createActor),
/* harmony export */   idlFactory: () => (/* reexport safe */ _academic_ecertificates_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var _academic_ecertificates_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./academic_ecertificates_backend.did.js */ "./src/declarations/academic_ecertificates_backend/academic_ecertificates_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_academic_ecertificates_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const academic_ecertificates_backend = canisterId ? createActor(canisterId) : undefined;
...
"use strict";
/*!**********************************************************!*\
  !*** ./src/academic_ecertificates_frontend/src/index.js ***!
  \**********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_academic_ecertificates_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/academic_ecertificates_backend */ "./src/declarations/academic_ecertificates_backend/index.js");
/* harmony import */ var _dfinity_auth_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @dfinity/auth-client */ "./node_modules/@dfinity/auth-client/lib/esm/index.js");
...
async function ic_interface_click(e) {
  ...
  if (e.target.getAttribute("status") === "connected") {
    academic_ecertificates_actor = _declarations_academic_ecertificates_backend__WEBPACK_IMPORTED_MODULE_0__.academic_ecertificates_backend;
    authClient.logout();
    redirect("/");
  } else {
    authClient.login({
...
async function handleAuthenticated(authClient) {
  ...
  academic_ecertificates_actor = (0,_declarations_academic_ecertificates_backend__WEBPACK_IMPORTED_MODULE_0__.createActor)(_declarations_academic_ecertificates_backend__WEBPACK_IMPORTED_MODULE_0__.canisterId, {
    agentOptions: {
      identity,
  ...
  submitbtn.addEventListener("click", async function (event) {
    ...
    if (!form.checkValidity()) {
      ...
      if (await authClient.isAuthenticated()) {
        var resp = await academic_ecertificates_actor.registerUniversity(
          $("#uni-name").val(),
          $("#uni-address").val(),
          BigInt($("#uni-phone").val()),
          $("#uni-email").val(),
          BigInt($("#uni-estdyr").val())
        );
        console.log(resp);
        if (resp.statusCode == BigInt(200)) {
...
<div class="inner-dotted-border">
 ...
 <span class="name"><b>` +
    name +
    `</b></span><br/>
 <span class="certify"><i>Bearing <B>` +
    rollno +
    `</B> Regd No. </i></span> <br/>
...
<div style="text-align: start !important;"><span class="certify" ><i>Certificate ID : </i></span>
  <a href="` +
    baseurl +
    encodeURIComponent(cert_id) +
    `"><b>` +
    cert_id +
    `</b></a></div>
</div>
</div><br>Issued by <a target='_blank' href='` +
    universityUrl +
    encodeURIComponent(cert_id.split("//")[0]) +
    `'>` +
    cert_id.split("//")[0] +
    `</a> .<br>`
  );
...
async function certificatesinit() {
      ...
      columns: [
        ...
        { data: "grad_date" },
        {
          ...
          render: function (data, type, row) {
            return (
              `<i class="fa-solid fa-eye" onclick="openModal('` +
              data +
              `')" data-id="` +
              data +
              `"></i>`
    ...
    $("i[data-id]").on("click", async function (e) {
      ...
      if (resp.statusCode == BigInt(200)) {
        var baseurl =
           false
            ? 0
            : `http://${"bd3sg-teaaa-aaaaa-qaaba-cai"}.localhost:4943/?cert=`;
        var universityUrl =
           false
            ? 0
            : `http://${"bd3sg-teaaa-aaaaa-qaaba-cai"}.localhost:4943/university.html?principal=`;
        var cert = render_certificate(
          baseurl,
          universityUrl,
          resp.cert[0].name,
          resp.cert[0].regd_no,
          resp.cert[0].branch,
          resp.cert[0].grad_date,
          resp.cert[0].id
        );
        $("#modalbody").html(cert);
        $("#modalopen").click();
  ...
  submitbtn.addEventListener("click", async function (event) {
    if (!form.checkValidity()) {
      ...
      var resp = await academic_ecertificates_actor.addCertificate(
        $("#name").val(),
        $("#rollno").val(),
        $("#branch").val()
      );
      $("#loading_icon").html("");
      if (resp.statusCode === BigInt(200)) {
        redirect("/certificates.html", {
          msg: "Created Certificate with ID " + resp.msg,
        });
      } else {
...
async function universityinit() {
  ...
  if (url.searchParams.has("principal")) {
    var universityPrincipal = decodeURIComponent(
      url.searchParams.get("principal")
    );
    var resp = await academic_ecertificates_actor.getUniversity([
      _dfinity_principal__WEBPACK_IMPORTED_MODULE_3__.Principal.fromText(universityPrincipal),
    ]);
    console.log(resp);
    if (resp.statusCode === BigInt(200)) {
      var university = resp.university[0];
...
const init = async () => {
  ...
  persistCannisterId("avqkn-guaaa-aaaaa-qaaea-cai");
  ...
  //creating authclient
  authClient = await _dfinity_auth_client__WEBPACK_IMPORTED_MODULE_1__.AuthClient.create();
  ...
  if (await authClient.isAuthenticated()) {
    ...
    if (
      ...
      window.location.pathname != "/university.html"
    ) {
      redirect("/");
    }
    setDisonnected();
